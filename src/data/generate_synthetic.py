...
def generate_synthetic_train_data(n_data: int, noise_level: float = 0.0,
    ...
    Y = np.sin(np.pi * U / 2.0) + high_freq_level * np.sin(10 * np.pi * U) + A ** 2 - 0.3 + rng.normal(0, noise_level, (n_data, 1))
